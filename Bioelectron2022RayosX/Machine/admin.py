...
class SistemaModel(admin.ModelAdmin):
    ...
    list_display = ('id',"marca","name_option","modelo","serie","antiguedad_year","year_instalacion","is_enabled","created_at")
...
class TuboModel(admin.ModelAdmin):
    list_display = ('id','title','name_option',"marca","modelo","serie","antiguedad_year","year_instalacion","is_enabled","created_at")