...
ALLOWED_HOSTS = ['localhost', '127.0.0.1','192.168.1.92','192.168.1.6','0399-181-66-137-216.sa.ngrok.io', config('SERVER', default='127.0.0.1')]
...
CORS_ORIGIN_WHITELIST = [
    ...
    "https://0399-181-66-137-216.sa.ngrok.io"
]
