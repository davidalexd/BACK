...
def mamografia_repetibilidad_cae(attribute_1=[0],attribute_2=[0],attribute_3=[0],attribute_4=[0],attribute_5=[0],attribute_6=[0],attribute_7=[0],attribute_8=[0],attribute_9=[0]):
