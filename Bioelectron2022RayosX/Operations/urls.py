...
urlpatterns = [
    ...
    path('OperacionMamografiaCompensacionCAE/<global>',views.view_mamografia_compensacion_cae_espesor_composicion_mama,name='mamografia_compensacion_cae_espesor_composición_mama'),   
