...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'db_table': 'customers_departamento_areas',
                'ordering': ['id'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ubicacion', models.CharField(db_column='ar_ubicacion_area', max_length=255, verbose_name='Area location')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pais', models.CharField(blank=True, db_column='dpt_pais', max_length=255, null=True, verbose_name='Country where the headquarters belongs')),
                ('departamento', models.CharField(blank=True, db_column='dpt_departamento', max_length=255, null=True, verbose_name='Department to which the headquarters belongs')),
                ('provincia', models.CharField(blank=True, db_column='dpt_provincia', max_length=255, null=True, verbose_name='Province to which the headquarters belongs')),
                ('distrito', models.CharField(blank=True, db_column='dpt_distrito', max_length=255, null=True, verbose_name='District to which the headquarters belongs')),
                ('is_enabled', models.BooleanField(default=True)),
                ('crated_at', models.DateTimeField(editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('razon_social', models.CharField(db_column='org_razon_social', max_length=255, unique=True, verbose_name="Organization's name")),
                ...
                ('pais', models.CharField(blank=True, db_column='org_pais', max_length=255, null=True, verbose_name='Country where the organization belongs')),
                ('departamento', models.CharField(blank=True, db_column='org_departamento', max_length=255, null=True, verbose_name='Department to which the organization belongs')),
                ('provincia', models.CharField(blank=True, db_column='org_provincia', max_length=255, null=True, verbose_name='Province to which the organization belongs')),
                ('distrito', models.CharField(blank=True, db_column='org_distrito', max_length=255, null=True, verbose_name='District to which the organization belongs')),
                ('is_enabled', models.BooleanField(default=True)),
                ('crated_at', models.DateTimeField(editable=False)),
