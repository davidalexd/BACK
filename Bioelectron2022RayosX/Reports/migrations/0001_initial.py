    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_control_calidad', models.DateField(auto_now_add=True, db_column='rpt_fecha_control_calidad', verbose_name='QC date')),
                ...
                ('image_3', models.ImageField(blank='', default='', upload_to='reports/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_reporte', models.CharField(blank=True, db_column='rpt_name_reporte', max_length=255, null=True, verbose_name='Report name')),
                ('numero_de_ot', models.CharField(blank=True, db_column='rpt_numero_orden_trabajo', max_length=255, null=True, verbose_name='Ot number')),
                ('fecha_control_calidad', models.DateField(blank=True, db_column='rpt_fecha_control_calidad', editable=False, verbose_name='QC date')),
                ('observacion', models.TextField(blank=True, db_column='rpt_observacion_reporte', null=True, verbose_name='Report observacion')),
                ('datos_del_cliente', models.JSONField(blank=True, db_column='rpt_data_clientes', null=True, verbose_name='Data for clients')),
                ('sistema', models.JSONField(blank=True, db_column='rpt_data_sistema', null=True, verbose_name='Data for system')),
                ('componente', models.JSONField(blank=True, db_column='rpt_data_component', null=True, verbose_name='Data for component')),
                ...
                ('title_image_3', models.CharField(db_column='rpt_title_image_3', max_length=255, null=True, verbose_name='Title image 3')),
                ('image_3', models.TextField(blank='', default='', max_length=100)),
