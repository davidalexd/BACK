...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(db_column='RptAr_id', primary_key=True, serialize=False)),
                ('cliente_static_details', models.JSONField(blank=True, db_column='RptAr_context', null=True, verbose_name="Customer's current details")),
                ('created_at', models.DateTimeField(editable=False)),
        ...
        migrations.AddField(
            model_name='reportsreportemodel',
            name='pruebas',
            field=models.ManyToManyField(through='Reports.Rpt_Prb_Model', to='Protocol.PruebasModel'),
        ),
        migrations.AddField(
            model_name='reportsreportemodel',
            name='tubo',
