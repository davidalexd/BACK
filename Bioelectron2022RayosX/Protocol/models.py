...
class ProtocolsModel(models.Model):
    ...
    nombre_protocolo = models.CharField("Protocol name",max_length=255,null=False,blank=False,unique=True,db_column="prt_name")
    detalles_protocolo = models.JSONField("Protocol details",editable=True,null=True,blank=True,db_column="prt_detalles")
