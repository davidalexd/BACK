...
from .viewsets import ProtocoloHistoryGenericViewSet, ProtocolosGenericViewSet, PruebaCalculoHistoryGenericViewSet, PruebaHistoryGenericViewSet, PruebaOpcionHistoryGenericViewSet, PruebasCalculoGenericViewSet, PruebasGenericViewSet, PruebasOpcionGenericViewSet, SeccionesGenericViewSet, SeccionesHistoryGenericViewSet, VariableGenericViewSet, VariablesHistoryGenericViewSet
...
router.register('Pruebas',PruebasGenericViewSet,basename='pruebas')
...
router.register('PruebasHistory',PruebaHistoryGenericViewSet,basename='pruebas-history')
