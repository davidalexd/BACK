    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'historical secciones models',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': User.models.User,
                'verbose_name_plural': 'historical prueba opciones models',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': User.models.User,
                'verbose_name_plural': 'historical prueba calculo models',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': User.models.User,
                'verbose_name_plural': 'historical protocols models',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
